...
long long dijkstra() {
    ...
    while (!frontier.empty()) {
        ...
        if (currNode.pathLength < 4) {
            updateFrontier(currNode.coordinates, {currNode.dir}, currNode.dir, currNode.pathLength, currNode.cost, frontier);
        }
        else if (currNode.pathLength == 10) {
